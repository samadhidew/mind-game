...
const imageArray = [
  ...
  {
    name: "Garfield",
    image: "img/garfield.png",
  },
  {
    name: "blue",
    image: "img/imagess.png",
  },
  {
    name: "man",
    image: "img/imagesg.png",
  },
  {
    name: "micky",
...
const markDisplay =document.querySelector('Marks');
const audio = new Audio("https://www.fesliyanstudios.com/play-mp3/387");

function createBoard() {
  imageArray.forEach((img, index) => {
    const card = document.createElement("img");
    card.setAttribute("src", "img/question.jpg");
    card.setAttribute("date-id", index);
...
function CheckMatch() {
  ...
  console.log("optionTwo", optionTwo.name);
if(optionOne.id===optionTwo.id){
    alert('You clicked the same card')
    cards[optionOne.id].setAttribute("src", "img/question.jpg");
    cards[optionTwo.id].setAttribute("src", "img/question.jpg");
}else if (optionOne.name === optionTwo.name) {
    //match
    cards[optionOne.id].setAttribute("src", "img/images.jpg");
    cards[optionTwo.id].setAttribute("src", "img/images.jpg");
  ...
  if(cardsWon.length === imageArray.length/2){
    markDisplay.innerHTML='You Won!'
    gridDisplay.startConfetti();
  }
}
